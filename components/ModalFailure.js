...
export default function ModalFailure({ message, closeModal }) {
  return (
    <BorderLayout>
      <div className="p-5">
      ...
      <div className="w-full max-w-md pt-1 space-y-3">
        <div className="flex flex-col justify-center items-center">
          <RxCross1 className="w-10 h-10 rounded-full text-red-200 bg-red-800 p-2" />
          <div className="font-bold text-gray-600 mt-4">Failed!</div>
          <p className="text-gray-800 px-4 text-center">
            {message}
          </p>
