...
import CampaignEvidence from "../components/CampaignEvidence";
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 rounded-lg bg-white p-8 shadow-sm ring-1 ring-slate-900/5 md:grid-cols-3">
              <div className="md:col-span-1">
                ...
                <p className="mt-1 text-sm leading-6 text-slate-500">
                  ...
                  be sent. We&apos;ll verify the account name to make sure
                  it&apos;s correct.
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 rounded-lg bg-white p-8 shadow-sm ring-1 ring-slate-900/5 md:grid-cols-3">
              <div className="md:col-span-1">
                ...
                <p className="mt-1 text-sm leading-6 text-slate-500">
                  ...
                  Remember, you won&apos;t be able to change the duration after
                  you launch.
                </p>
              </div>
              <div className="md:col-span-2">
